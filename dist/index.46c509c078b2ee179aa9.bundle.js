...
.tile {
  background-color: var(--tile-clr, black);
  
  border: 1px solid var(--border-clr, darkorange);
  
  margin: 0px;
}

.trail {
  background-color: var(--trail-clr, orange);
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;;EAGE,sBAAsB;AACxB;;AAEA;EACE,wBAAwB;EACxB,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,uBAAuB;;EAEvB,iBAAiB;EACjB,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,eAAe;EACf,SAAS;AACX;;AAEA;EACE,wCAAwC;;EAExC,+CAA+C;;EAE/C,WAAW;AACb;;AAEA;EACE,0CAA0C;AAC5C","sourcesContent":["*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n:root {\n  --border-clr: darkorange;\n  --trail-clr: orange;\n  --tile-clr: rgb(0,0,0);\n}\n\nbody {\n  background-color: white;\n\n  max-height: 100vh;\n  max-width: 600px;\n  margin: 0 auto;\n}\n\nh1 {\n  padding: 0.5rem;\n  margin: 0;\n}\n\n.tile {\n  background-color: var(--tile-clr, black);\n  \n  border: 1px solid var(--border-clr, darkorange);\n  \n  margin: 0px;\n}\n\n.trail {\n  background-color: var(--trail-clr, orange);\n}"],"sourceRoot":""}]);
// Exports
