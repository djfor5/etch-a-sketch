...
let gridLength
do {
  gridLength = parseInt(prompt("Enter the grid size, N, for an N x N grid (maximum 100, otherwise defaults to 16): ")) || 16
} while (gridLength > 100)

const allowToggle = false // allows infinite toggle of div colour when clicking or hovering over div
